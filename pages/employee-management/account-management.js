...
function renderAccounts() {
    ...
    employees.forEach(employee => {
        ...
        tr.innerHTML = `
            <td scope="row"
                  class="px-6 py-4 font-medium text-heading whitespace-nowrap">${employee.MaNhanVien}</td>

            <td class="px-6 py-4">${employee.HoTen}</td>

            <td class="px-6 py-4">${employee.DcEmail}</td>

            <td class="px-6 py-4">${employee.Vaitro}</td>
